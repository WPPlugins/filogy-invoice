...
$template_panels_data = array(
	...
	'widgets' => array(					//this contains the specific widgets
		...
		array( 							
			'class' => 'FILO_Widget_Invbld_Head_Data_Horizontal',
			'widget_code' => 'FILO_Widget_Invbld_Head_Data_Horizontal',
		),
	...
	'grids' => array(					//this contains the specific rows
		...
		array(
			'id' => 'Filo_Addresses_Row',
		),
		array(
			'id' => 'Filo_Data_Horizontal',
		),		
		/*array(
		...
		array(
			'id' => 'Filo_Payment_And_Shipping_Data_Row',
		),
