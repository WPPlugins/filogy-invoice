...
//wsl_log(null, 'document-header.php 0: ' . wsl_vartotext(''));

// <html>  // We do not use <html>, because in case of bulk generation, DOMPDF cannot handle more <html> tag (no <html> is no problem)
// the individual pages /templates/00_filogy_original/documents/css/document_styles.css.php and /templates/01_filogy_standard/documents/css/document_general_layout.css.php are loaded by class-filo-initial-functions.php 
?>
...
<!DOCTYPE html>	
    <head>
        ...
        <link rel='stylesheet' id='filo_document_layout'  href='<?php echo FILO()->plugin_url() . '/templates/00_filogy_original/documents/css/document_layout.css'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' id='filo_document_styles_general'  href='<?php echo home_url() . '?filo_individual_page=template00_document_styles_css&fileformat=' . $output_format; ?>' type='text/css' media='all' />
